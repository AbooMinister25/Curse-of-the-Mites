...
class BaseRoom(ABC):
    ...
    def __init__(self, _title: str, _display_char: str, _color: (int, int, int), _description: str,
                 _linked_rooms: dict, _display_x: int, _display_y: int):
        """
        Base Room
        ...
        :param _linked_rooms: list of linked rooms
        """
